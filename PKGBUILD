...
source=("$pkgname-$pkgver.tar.gz::$url/releases/download/v0.8.5/$pkgname-$pkgver.tar.gz")
sha256sums=('0a7598288f35bccf49e149336f699e0b3ae846ef2c50f2b247a6cd099f0cec29')
